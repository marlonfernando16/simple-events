...
<body>
	...
	<div class="row container">
		<p>&nbsp;</p>
		<form:form
			action="${pageContext.request.contextPath }/especialidades/update/${especialidade.id}"
			method="post" class="col s12 white " modelAttribute="especialidade">
			<fieldset class="formulario">
				...
				<div class="input-field col s12">
					<input type="submit" value="atualizar" class="btn blue"> <a
						href="${pageContext.request.contextPath }/especialidades"
